...
# right_arm = ref_tool.find_any(serial_number="3950366E3233", logger=logger)
# right_arm = ref_tool.find_any(serial_number="395136713233", logger=logger)
# left_arm = ref_tool.find_any(serial_number="3950366E3233", logger=logger)
left_arm = fibre.find_any(serial_number="208C31875253", logger=logger)
#%%
right_arm = fibre.find_any(serial_number="396636713233", logger=logger)
...
teleop.start()
#%%
from dummy_env_real import make_dummy_env
env = make_dummy_env()
