...
while not stop:
    ...
    teach_eef = arm_controller.get_teach_current_pose()
    print(f"Teach eef: {teach_eef}")
    follow_arm.robot.move_l(*teach_eef)
    follow_arm.robot.hand.set_angle(teach_arm.robot.hand.angle - teach_hand_init_angle + follow_hand_init_angle)
    follow_eef = arm_controller.get_follow_current_pose()
    follow_hand = follow_arm.robot.hand.angle
    teach_hand = follow_hand
