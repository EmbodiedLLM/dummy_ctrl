...
def get_precise_timestamp(timer_start_time: float) -> float:
    """Get timestamp relative to timer start time"""
    return time.monotonic() - timer_start_time
