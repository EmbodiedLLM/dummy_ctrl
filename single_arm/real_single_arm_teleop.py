...
# %%
# teach_arm_right = fibre.find_any(serial_number="3950366E3233", logger=logger)
# print(follow_arm.robot.hand.angle)
# print(follow_arm.robot.hand.get_mode())
# print(follow_arm.robot.hand.get_current_limit())
# follow_arm.robot.hand.enable_close_loop()
# print(follow_arm.robot.hand)
# print(teach_arm.robot.resting())
# %%
# follow_arm.robot.hand.set_mode(2)
# %%
# follow_arm.robot.hand.set_angle(0)
